module.exports = {
  ...
  '6ni6ok3ym7mf1p33l123': {
    ...
    timestamp: 769651920000,
    title:
      'Anatomy of a malicious script: how a website can take over your browser',
    summary:
      'By now, we all know that the major tech behemoths like Facebook or Google know everything about our lives',
    body:
      'Including how often we go to the bathroom (hence all the prostate medication ads that keep popping up, even on reputable news sites). After all, we’ve given them permission to do so, by reading pages and pages of legalese in their T&C pages (we all did, didn’t we?) and clicking on the "Accept" button.',
    author: 'Paolo Mioni',
    category: 'javascript',
    voteScore: 60,
    deleted: false,
  ...
  '6ni6ok3ym7mf1p33l456': {
    ...
    timestamp: 1519085520000,
    title: 'Turn Sublime Text 3 into a JavaScript IDE',
    summary:
      'Sublime Text is one of the most popular editors for web development and software development in general.',
    body:
      'Its very smooth and fast compared to other editors (being written in C++ helps that speed). Sublime also has tons of plugins you can find through Package Control. But it’s only a text editor and not an IDE. An IDE is a software application that provides comprehensive facilities to computer programmers for software development. In fact, Sublime doesn’t offer features like debugging tools, built-in tools for compiling and running applications, intelligent code suggestions, or code refactoring. Instead it offers a set of APIs you can use to extend it. Here’s an summary to the JavaScript Enhancement plugin (my own creation) that makes Sublime a bit more IDE-like for JavaScript development.',
  ...
  cccok3ym7mf1p33lnez: {
    ...
    timestamp: 1069599600000,
    title: 'Creating a Static API from a Repository',
    summary:
      'When I first started building websites, the proposition was quite basic:',
    body:
      "Take content, which may or may not be stored in some form of database, and deliver it to people's browsers as HTML pages. Over the years, countless products used that simple model to offer all-in-one solutions for content management and delivery on the web. Fast-forward a decade or so and developers are presented with a very different reality. With such a vast landscape of devices consuming digital content, it's now imperative to consider how content can be delivered not only to web browsers, but also to native mobile applications, IoT devices, and other mediums yet to come.",
  ...
  '6feaok3ym7mf1p33lnez': {
    ...
    timestamp: 1542726000000,
    title: 'The peculiar magic of flexbox and auto margins',
    summary:
      'In front-end development, there are often times when I know that I don’t know something.',
    body:
